...
GF_AUTOMATIC_TRANSLATE		= "Translate your messages that you send to China/World"
GF_ERROR_FILTER				= "Enable Error Filtering"
GF_CUR_CHAT_FRAME			= "Use current Chatframe"
...
GF_SearchFrameShowChinaCheckButton = { 
	tooltip1 		= "Show China", 
	tooltip2 		= "When checked, results will increase Chinese groups." },
...
GF_SearchFrameShowPVPCheckButton = { 
